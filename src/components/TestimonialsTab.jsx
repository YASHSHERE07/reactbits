...
import ACards from "./lib/ACards";
import BCards from "./lib/BCards";
import CCards from "./lib/CCards";
import DCards from "./lib/DCards";
import ATest from "./lib/ATest";
    ...
    <div>
      <div className="w-full max-w-7xl mx-auto p-4">
        ...
        <div className="border-y-4 m-5 p-2 text-5xl font-semibold">
          <h1 className="ml-4 text-blue-900  font-oswald">Cards</h1>
        </div>
