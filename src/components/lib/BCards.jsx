...
import ACardCollection from "../comp/ACardCollection";
import BCardCollection from "../comp/BCardCollection";
import BCardCode from "../code/BCardCode";
        ...
        {activeTab === "code" && (
          <div className="p-2 sm:p-4 rounded-lg">
            ...
            <pre className="text-white p-2 sm:p-4 rounded-lg">
              <BCardCode txt="code/avatars.txt" />
            </pre>
          </div>
        )}
      </div>
