...
const Temp5 = () => {
  ...
  return (
    <div>
      ...
      <TempModal isOpen={isModalOpen} onClose={handleCloseModal} page="Temp5" />
      ...
      <div className="max-w-full md:max-w-[1600px] justify-center">
        <div className="min-h-screen bg-white border-4">
          ...
          <section className="mx-20 mt-20">
            <h1 className="font-oswald text-5xl">ALL PRODUCTS</h1>
            <div className="bg-purple-100 pt-3 rounded-lg shadow-lg w-full flex flex-wrap justify-around items-center mt-10 font-source-sans border-2 border-gray-200">
              <div className="flex flex-col items-center  w-full sm:w-1/5">
                <h3 className="text-xl font-semibold ">Category</h3>
                <select className="form-select block w-full border-2 py-1 rounded border-gray-400">
                  <option>ALL</option>
              ...
              <div className="flex justify-center mt-10 mb-4 w-full">
                <button className="bg-purple-500 text-white hover:bg-purple-700 rounded-lg px-4 py-2">
                  Apply Filters
                </button>
              </div>
            </div>
